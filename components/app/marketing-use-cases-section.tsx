          ...
          {items.map(({ name, description, icon: Icon }, index) => (
            ...
            >
              <div className="flex flex-col items-center gap-y-2">
                <div className="from-primary to-primary/80 group-hover:from-secondary group-hover:to-secondary/80 rounded-lg bg-gradient-to-b p-2 text-white transition-colors">
                  {Icon}
                </div>
