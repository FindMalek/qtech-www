...
export function MarketingCompanyShowcase() {
  ...
  return (
    ...
    >
      ...
      <div className="border-border z-20 grid w-full max-w-7xl grid-cols-2 items-center justify-center overflow-hidden border-y md:grid-cols-3">
        {companyShowcase.companyLogos.map((logo) => (
          <Link
            ...
            key={logo.id}
          >
            <div className="[cubic-bezier(0.165, 0.84, 0.44, 1)] flex h-full w-full translate-y-0 items-center justify-center transition-all duration-300 group-hover:-translate-y-4">
              {logo.logo}
            </div>
